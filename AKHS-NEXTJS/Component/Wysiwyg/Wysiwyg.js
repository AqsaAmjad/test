const Wysiwyg = () => {
    ...
    return (
    <>
         <h4 dangerouslySetInnerHTML={{ __html: description.length > maxLength ? description.substring(0,maxLength) + '...' : description.substring(0,maxLength) }}/>
        <div>first div</div>
        <div>second div</div>
        <div>third div</div>
    </>
