    ...
    <section id={props.attributes.anchorId} className='anchor flex flex-wrap pt-10 sm:pt-14'>
      {
        Object.keys(props.attributes.areaOfActivityItem).map((key => {
          ...
          return (
            <>
              <div className='w-full sm:w-1/2 xl:w-1/3 sm:px-2 lg:px-5'>
                  ...
                  <div className='px-6 sm:px-3'>
                    ...
                    }
                    {
                      ...
                      <>
                        ...
                        <div className='hidden sm:block leading-normal ul-styles ol-styles blue-link' dangerouslySetInnerHTML={{ __html:wysiwyg.length > maxLength ?  dictionaryFunction(wysiwyg.substring(0, maxLength) , false, props.datoDictionary) + '...' :  dictionaryFunction(wysiwyg.substring(0, maxLength) , false, props.datoDictionary)}} />
